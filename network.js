...
async function initGraph() {
    ...
    // ⚡ Bolt: Use a Set to track connected users in O(1) time
    // instead of filtering the links array in O(L) time inside the loop.
    // This reduces initialization complexity from O(N^3) to O(N^2).
