...
async function initGraph() {
    ...
    // Bolt Optimization: Use a Set to track connected users for O(1) lookups
    // This replaces an O(L) links.filter() call inside the loop, reducing complexity from O(N^3) to O(N^2)
