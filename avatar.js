...
class SoulAvatarSystem {
    ...
    animate() {
        ...
        // Optimization: Use getElementsByClassName instead of querySelectorAll for better performance
        // and cache window.innerHeight to avoid layout thrashing per iteration.
