...
class SoulAvatarSystem {
    ...
    animate() {
        ...
        // Caching layout properties and using live HTMLCollection for O(1) loop iteration
        ...
        for (let i = 0; i < len; i++) {
            ...
            // ⚡ Bolt: Using cached winHeight prevents repetitive layout reflows per frame
